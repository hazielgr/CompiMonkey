...
# actores
monkey_lvl3 = Monkey(100, 0)
# nivel4
# superficies
desert = grass = [DESERT, (0, 0, 800, 900), "desert"]
# actores
rata_lvl4 = Monkey(200, 400)
# nivel5
# superficies
# actores
rata_lvl5 = Monkey(200, 400)
# nivel6
# superficies
river1_lvl6 = [BLUE, (0, 0, 800, 100), "river"]
river2_lvl6 = [BLUE, (0, 0, 100, 900), "river"]
river3_lvl6 = [BLUE, (700, 0, 100, 900), "river"]
river4_lvl6 = [BLUE, (300, 0, 200, 900), "river"]
river5_lvl6 = [BLUE, (0, 300, 800, 200), "river"]
river6_lvl6 = [BLUE, (0, 700, 800, 200), "river"]
...
def level6():
    ...
    actors = [monkey_lvl6, bananas, monkey_lvl6.score, turtles, matches, alligators, rats, beavers, river1_lvl6,
              river2_lvl6, river3_lvl6, river4_lvl6, river5_lvl6, river6_lvl6, island1, island2,
              island3, island4]
    return actors
