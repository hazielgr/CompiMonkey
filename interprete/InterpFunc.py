from errores.ErrorHandler import RTError
from interprete.RunTimeResult import *
##########################################################
# Clase Value: Revisa da error si la operacion no es valida
#########################################################
class Value:
    def __init__(self):
        self.set_pos()
...
##########################################################
# Clase Numero: Revisa si puede realizar la operacion
#########################################################
class Numero(Value):
