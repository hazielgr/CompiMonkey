from interprete.RTResult import *
from interprete.SymbolTable import *
...
BuiltInFunction.turn = BuiltInFunction("turn")
...
global_symbol_table.set("turn", BuiltInFunction.turn)
